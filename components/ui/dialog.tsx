...
>(({ className, children, side = "center", ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed z-50 border bg-background shadow-lg focus:outline-none",
        side === "center"
          ? "left-1/2 top-1/2 w-full max-w-lg -translate-x-1/2 -translate-y-1/2 rounded-lg p-5"
          : "right-0 top-0 h-full w-full max-w-xl overflow-y-auto border-l p-5 sm:w-[32rem]",
        className,
      )}
      {...props}
    >
